...
# here I have to keep calling the dataframe name
# and use the logical operators with '&' and combine them.
...
MyNewColumn <- head(mutate(flights, MyNewColumn = arr_delay - dep_delay))
View(MyNewColumn)
...
# summarise() in dplyr
# The summarize() allows us to summarize the data frame into a single row using another aggregate function
...
# if you want to pick a percentage of rows, sample_frac() function allow us to do that,
